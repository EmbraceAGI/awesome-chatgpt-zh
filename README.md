...
- [🤖 ChatGPT 中文指南 🤖](#-chatgpt-中文指南-)
  ...
  - [思考](#思考)
    ...
    - [36氪研究院 | 2023年AIGC之ChatGPT行业研究报告](#36氪研究院--2023年aigc之chatgpt行业研究报告)
...
- [ChatGPT-Plus](https://github.com/zhpd/chatgpt-plus) 基于 React + Nextjs 开发的ChatGPT应用，支持提示词、插件、商城功能。
...
### [36氪研究院 | 2023年AIGC之ChatGPT行业研究报告](https://36kr.com/p/2131399229861121)

随着关键技术与基础理论不断突破，大算力、大数据、大模型将成为未来重点发展方向，带动自然语言处理、翻译模型、生成算法和数据集等细分要素持续提升，推动产出的内容细节、类型更丰富、质量更高。
